...
export const Bell = (p: { size?: number }) => (
  <IconBase {...p}>
...
export const Wifi = (p: { size?: number }) => (
  <IconBase {...p}>
...
export const RotateCcw = (p: { size?: number }) => (
  <IconBase {...p}>
    <polyline points="1 4 1 10 7 10" />
    <path d="M3.51 15a9 9 0 108.49-11" />
  </IconBase>
);

export const Download = (p: { size?: number }) => (
  <IconBase {...p}>
...
export const Mascot = ({ size = 28 }: { size?: number }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 64 64"
